...
export default function MainListPage() {
  ...
  const fetchAdmissions = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/army-admissions?listType=MAIN&limit=1000');
      if (response.ok) {
      ...
      <div className="min-h-screen bg-gradient-to-b from-military-midnight via-military-navy to-military-midnight">
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold text-military-gold mb-2">90RRI Main List</h1>
            <p className="text-military-muted">
              Official list of shortlisted candidates for 90th Regular Recruit Intake - Lagos State
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
              ...
              <div className="text-right">
                <p className="text-military-muted text-sm">
                  Showing{' '}
                  <span className="text-military-gold font-bold">{filteredAdmissions.length}</span> of{' '}
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-military-navy/50 border-b border-military-gold/20">
                    <tr>
                      <th className="px-4 py-4 text-left text-xs font-semibold text-military-gold uppercase">#</th>
                      <th className="px-4 py-4 text-left text-xs font-semibold text-military-gold uppercase">
                        Application Number
                      </th>
                      <th className="px-4 py-4 text-left text-xs font-semibold text-military-gold uppercase">
                        Surname
                    ...
                    {filteredAdmissions.length === 0 ? (
                      ...
                      filteredAdmissions.map((admission, index) => (
                        <tr key={admission.id} className="hover:bg-white/5 transition-colors">
                          ...
                          <td className="px-4 py-3 text-sm text-military-gold font-mono">
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm">
                ...
                <p className="text-military-muted">
                  ...
                  <a href="https://recruitment.army.mil.ng/drm?state=Lagos" target="_blank" rel="noopener noreferrer" className="text-military-gold hover:underline">
